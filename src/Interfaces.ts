...
export function getStudentsData(): IStudentData[] {
     ...
     *
     */
    let student1: IStudentData = {name:'Ivan', secondName: 'Petrov', age: 20, phone: '+7(555)555-55-50'};
    let student2: IStudentData = {name:'Stepan', secondName: 'Petrov', age: 19, phone: '+7(555)555-55-51'};
    let student3: IStudentData = {name:'Petr', secondName: 'Ivanov', age: 19};
